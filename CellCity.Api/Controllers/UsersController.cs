...
namespace CellCity.Api.Controllers
{
    ...
    */
    public class UsersController : ODataController
    {
        ...
        // GET: odata/Users(5)/Orders
        [EnableQuery]
        public IQueryable<Order> GetOrders([FromODataUri] int key)
        {
            return db.Users.Where(m => m.userId == key).SelectMany(m => m.Orders);
        }

        // GET: odata/Users(5)/WishLists
        [EnableQuery]
        public IQueryable<WishList> GetWishLists([FromODataUri] int key)
        {
            return db.Users.Where(m => m.userId == key).SelectMany(m => m.WishLists);
        }
